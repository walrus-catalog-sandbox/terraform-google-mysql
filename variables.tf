...
```
infrastructure:
  vpc_id: string, optional                  # the ID of the VPC where the MySQL service applies. It is a fully-qualified resource name, such as projects/{project_id}/global/networks/{network_id}.
```
EOF
  type = object({
